...
def analyze_text(filename):
    """Calcuate the number of lines and characters in a file.
...
class TextAnalysisTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(self.filename, 'w') as f:
            f.write('Now we are engaged in a great civil war.\n'
                    'testing wheyjer that nation,\n'
                    'or any nation so conceived and so dedicated,\n'
                    'can long endure.')

    def tearDown(self):
        """Fixure that deletes the files used by the test methods."""
        try:
    ...
    def test_function_runs(self):
        """Basic smoke test: does the funciton run?"""
